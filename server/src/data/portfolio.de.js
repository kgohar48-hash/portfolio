/**
 * German translation of portfolio.js. Keep the shape identical to the
 * English source — the API serves this at GET /api/portfolio?lang=de and
 * the seed script pushes it into MongoDB under the "portfolio_de" key.
 * Numeric metric values are intentionally left unchanged (see StatStrip's
 * CountUp parser, which expects "," as the thousands separator).
 */
...
export const portfolio = {
  ...
  skills: [
    {
      title: "Sprachen",
      items: ["JavaScript (Node.js, React)", "TypeScript", "Python", "R", "SQL", "C++"]
    },
    {
      title: "Systeme & Performance",
      items: ["Caching", "Rate Limiting", "Nebenläufigkeit (Event Loop)", "Queue-Systeme", "Retry-Logik", "Komplexitäts-Trade-offs"]
    },
    {
      title: "Backend & APIs",
      items: ["REST-APIs", "Node.js-Architektur", "MongoDB", "Express", "Git", "Docker", "Cloud-Deployment (Render / Serverless)"]
    },
    {
      title: "Daten & KI",
      items: ["LLM-Integration", "RAG-Pipelines", "NLP", "ML & Deep Learning", "Datenvisualisierung", "Databricks"]
    }
  ],
  ...
  projects: [
    ...
    },
    {
      ...
      blurb:
        "KI-gestützte Plattform zur Finanzdatenanalyse, die aus unübersichtlichen Kontoauszügen saubere, strukturierte Erkenntnisse extrahiert.",
      details: [
    ...
    },
    {
      ...
      url: "",
      blurb:
        "Echtzeit-Automatisierungsplattform, gebaut für Nebenläufigkeit, Zuverlässigkeit und kosteneffizienten Durchsatz.",
      details: [
    ...
    },
    {
      ...
      url: "",
      blurb:
        "MERN-Plattform für Studierende, mit analysegetriebener Iteration und skalierbaren Datenmodellen.",
      details: [
  ...
  philosophy: [
    {
      ...
      body: "Messen, optimieren und Latenz unter Last schützen. Effizienz ist ein Feature."
    },
    {
      title: "Skalierbarkeit von Anfang an",
      body: "Nebenläufigkeit, Queues, Caching und Fehlertoleranz von Tag eins an eingebaut."
    },
    {
      title: "Saubere, wartbare Architektur",
      body: "Modulare Grenzen, vorhersagbare Codepfade und einfache Abstraktionen."
    },
    {
      title: "Datengetriebene Entscheidungen",
      body: "Schnell ausliefern, das System instrumentieren und anhand echter Signale iterieren."
    }
  ],
  ...
  bookshelf: [
    {
      title: "Die Errettung aus dem Irrtum",
      author: "Al-Ghazali",
      year: "1108",
      coverId: "deliverance-from-error",
      quote: "",
      tags: ["Islam", "Erkenntnistheorie", "Zweifel"]
    },
    {
      title: "Weiße Nächte",
      ...
      quote: "",
      tags: ["Einsamkeit", "Sehnsucht", "Romantik"]
    },
    {
      ...
      quote: "Irgendein Sinn ist besser als gar kein Sinn.",
      tags: ["Moral", "Ressentiment", "Genealogie"]
    },
    {
      ...
      quote: "",
      tags: ["Kognition", "Denkfehler", "Entscheidungsfindung"]
    },
    {
      ...
      quote: "",
      tags: ["Adlerianische Psychologie", "Freiheit", "Beziehungen"]
    }
  ],
