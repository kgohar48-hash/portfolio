 ...
 * The API serves this object at GET /api/portfolio and the seed script
 * pushes it into MongoDB. Edit here, re-deploy, done.
 */
...
export const portfolio = {
  ...
  skills: [
    ...
    },
    {
      ...
      items: ["Caching", "Rate limiting", "Concurrency (event loop)", "Queue systems", "Retry logic", "Complexity trade-offs"]
    },
    {
      title: "Backend & APIs",
      items: ["REST APIs", "Node.js architecture", "MongoDB", "Express", "Git", "Docker", "Cloud deployment (Render / serverless)"]
    },
    {
      title: "Data & AI",
      items: ["LLM integration", "RAG pipelines", "NLP", "ML & deep learning", "Data visualization", "Databricks"]
    }
  ],
  ...
  philosophy: [
    {
      ...
      body: "Measure, optimize, and protect latency under load. Efficiency is a feature."
    },
    {
      title: "Scalability by design",
      body: "Concurrency, queues, caching, and fault tolerance baked in from day one."
    },
    {
      title: "Clean, maintainable architecture",
      body: "Modular boundaries, predictable code paths, and simple abstractions."
    },
    {
      title: "Data-driven decisions",
      body: "Ship fast, instrument the system, and iterate on real signals."
    }
  ],
